...
if [[ "${ARCH}" == "ARM64" ]]; then
 	...
 	"D:/a/eden-nightly/Qt/6.9.0/msvc2022_64/bin/windeployqt6.exe" --qtpaths "D:/a/eden-nightly/Qt/6.9.0/msvc2022_arm64/bin/qtpaths6.bat" --release --no-compiler-runtime --no-opengl-sw --no-system-d3d-compiler --no-system-dxc-compiler --dir bin "$EXE_PATH"
else
